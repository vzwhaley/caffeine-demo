<template>
    <div>
        <h3 class="text-center">Update Caffeinated Drink</h3>
        <div class="alert alert-success" v-if="submitted">
            Caffeinated drink successfully updated!
        </div>
        <div class="row">
            <div class="col-md-6">
                <form @submit.prevent="updateDrink">
                    ...
                    <button type="submit" class="btn btn-primary">Update Caffeinated Drink</button>
                </form>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        getDrink() {
            axios
                .get(`/api/drink/${this.$route.params.id}`)
                .then(response => {
        ...
        updateDrink() {
            ...
            axios
                .post(`/api/drink/edit/${this.$route.params.id}`, {
